 ...
 * @author 26003980
 */
public class TrabBorderLayout extends javax.swing.JFrame {

    /**
     * Creates new form TrabBorderLayout
     */
    public TrabBorderLayout() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TrabBorderLayout.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TrabBorderLayout().setVisible(true);
            }
        });
    }
